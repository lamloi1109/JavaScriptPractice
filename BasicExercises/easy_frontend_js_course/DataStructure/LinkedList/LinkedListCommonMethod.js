...
// console.log('Size', numberLinkedList.size());
// console.log(numberLinkedList.findIndexByData(6));
// console.log(numberLinkedList.findIndexByData(4));
// console.log(numberLinkedList.findByIndex(2));
// console.log(numberLinkedList.findWithCallBack((x) => x % 2 === 0));
// // console.log(numberLinkedList.findWithCallBack((x) => x > 5));
// numberLinkedList.insertBeforePosition(1, 2);
// numberLinkedList.insertBeforePosition(0, -2);
// numberLinkedList.insertBeforePosition(5, 10);

numberLinkedList.printLinkedList();
console.log(numberLinkedList.removeByIndex(-2));
