import { countEmails, countEmailsV2, countEmailsV3 } from "./string_04";
...
describe("countEmailsV2(str)", () => {
  test("should return -1 when str is not a string or str length is 0 ", () => {
    [{}, undefined, null, [], {}].forEach((element) => {
      expect(countEmailsV2(element)).toBe(-1);
    });
  });
  test("should return 0 when str is not a string or str length is 0", () => {
    ["", "", ``].forEach((element) => {
      expect(countEmailsV2(element)).toBe(0);
    });
  });
  ...
  test("should return number when str have emails", () => {
    [
      ...
      expect(countEmailsV2(element)).toBe(3);
    });
  });
});
...
describe("countEmailsV3(str)", () => {
  test("should return -1 when str is not a string or str length is 0 ", () => {
    [{}, undefined, null, [], {}].forEach((element) => {
      expect(countEmailsV3(element)).toBe(-1);
    });
  });
  test("should return 0 when str is not a string or str length is 0", () => {
    ["", "", ``].forEach((element) => {
      expect(countEmailsV3(element)).toBe(0);
    });
  });
  ...
  test("should return number when str have emails", () => {
    [
      ...
      expect(countEmailsV3(element)).toBe(3);
    });
  });
});
