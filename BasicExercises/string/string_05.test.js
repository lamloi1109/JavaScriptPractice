import { countURLs, countURLsV2, countURLsV3 } from "./string_05.js";
...
describe("countURLs(str)", () => {
  ...
  test("should return 0 when str has not URL (URL is invalid)", () => {
    [
      "my website is: https://ez.com you can visit it",
      "my website is:",
    ].forEach((str) => {
      expect(countURLs(str)).toBe(0);
    });
  ...
  test("should return number URL when str has URL (URL is valid)", () => {
    ["my website is: http://ezfrontend.com you can visit it"].forEach((str) => {
      expect(countURLs(str)).toBe(1);
    });
  });
});
...
describe("countURLsV2(str)", () => {
  test("should return -1 when str is not a string", () => {
    [NaN, null, undefined, {}, []].forEach((str) => {
      expect(countURLsV2(str)).toBe(-1);
    });
  });

  test("should return 0 when str length is 0", () => {
    ["", ``, ""].forEach((str) => {
      expect(countURLsV2(str)).toBe(0);
    });
  });
  ...
  test("should return number URL when str has URL (URL is valid)", () => {
    [
      "my     website       is:         http://ezfrontend.com you can visit it",
    ].forEach((str) => {
      expect(countURLsV2(str)).toBe(1);
    });
  });
...
describe("countURLsV3(str)", () => {
  test("should return -1 when str is not a string", () => {
    [NaN, null, undefined, {}, []].forEach((str) => {
      expect(countURLsV3(str)).toBe(-1);
    });
  });

  test("should return 0 when str length is 0", () => {
    ["", ``, ""].forEach((str) => {
      expect(countURLsV3(str)).toBe(0);
    });
  });
